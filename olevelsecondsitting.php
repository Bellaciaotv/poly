...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST["submitsecondsitting"])) {
    $conn= mysqli_connect('localhost', 'root', '', 'fedpolyado') or die('Connection Failed' .mysqli_connect_error());
    {
        ...
        $sql= "INSERT INTO olevel_second_sitting (type,exam_no,exam_year,scratch_card_pin,scratch_card_serial_no,subject_1,grade_1,subject_2,grade_2,subject_3,grade_3,subject_4,grade_4,subject_5,grade_5,subject_6,grade_6,subject_7,grade_7,subject_8,grade_8,subject_9,grade_9) VALUES ('$type','$exam_no','$exam_year''$scratch_card_pin','$scratch_card_serial_no','$subject_1','$grade_1','$subject_2','$grade_2','$subject_3','$grade_3','$subject_4','$grade_4','$subject_5','$grade_5','$subject_6','$grade_6','$subject_7','$grade_7','$subject_8','$grade_8','$subject_9','$grade_9')";
