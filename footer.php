            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg text-center mb-3 mb-lg-0">
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item mx-2"><a class="link-muted" href="https://twitter.com/AdoFederal"><i class="gd-twitter-alt"></i></a></li>
                        <li class="list-inline-item mx-2"><a class="link-muted" href="https://www.facebook.com/fpadesk/"><i class="gd-facebook"></i></a></li>
                        <li class="list-inline-item mx-2"><a class="link-muted" href="https://fedpolyado.edu.ng/contact-us/#contact-form"><i class="gd-mail"></i></a></li>
                    </ul>
                </div>

                <div class="col-lg text-center text-lg-right">
                    &copy; 2022 The Federal Polytechnic, Ado-Ekiti. All Rights Reserved.
                </div>
            </div>
        </footer>
        <!-- End Footer -->
