                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="panel panel-default tabs">  
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-link d-flex align-items-center py-2 px-3 active"><a href="#tab-first" role="tab" data-toggle="tab">Personal Data</a></li>
                                        <li class="nav-link d-flex align-items-center py-2 px-3"><a href="#tab-second" role="tab" data-toggle="tab">Payment Settings</a></li>
                                        <li class="nav-link d-flex align-items-center py-2 px-3 "><a href="#tab-third" role="tab" data-toggle="tab">Email Settings</a></li>
                                    </ul>
